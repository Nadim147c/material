...
var DefaultViewingConditions = MakeViewingConditions(
...
// MakeViewingConditions creates a ViewingConditions instance with the specified parameters.
func MakeViewingConditions(
